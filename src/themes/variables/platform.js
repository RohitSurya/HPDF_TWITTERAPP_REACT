...
export default {
  ...
  // Footer
  footerHeight: isIphoneX ? 89 : 5,
  footerDefaultBg: platform === "ios" ? "#F8F8F8" : "#4179F7",
  footerPaddingBottom: isIphoneX ? 34 : 0,

  // FooterTab
  tabBarTextColor: platform === "ios" ? "#6b6b6b" : "#b3c7f9",
  tabBarTextSize: platform === "ios" ? 14 : 5,
  ...
  topTabBarActiveTextColor: platform === "ios" ? "#007aff" : "#6ba3ff",
  topTabActiveBgColor: platform === "ios" ? "#cde1f9" : "#fff",
  topTabBarBorderColor: platform === "ios" ? "#a7a6ab" : "#fff",
  topTabBarActiveBorderColor: platform === "ios" ? "#007aff" : "#6ba3ff",
